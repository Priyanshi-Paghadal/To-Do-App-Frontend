...
function App() {
  ...
  const getTasks = async () => {
    try {
      const res = await axios.get('https://to-do-app-backend-rho.vercel.app/api/todo/allTodo');
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(`https://to-do-app-backend-rho.vercel.app/api/todo/updateStatus/${id}`, { status });
      getTasks();
    } catch (err) {
  ...
  const AddTask = async (e) => {
    ...
    try {
      const res = await axios.post('https://to-do-app-backend-rho.vercel.app/api/todo/addTodo', { taskName, taskType });
      setTaskName('');
      setTaskType('');
  ...
  const deleteTask = async (id) => {
    try {
      await axios.delete(`https://to-do-app-backend-rho.vercel.app/api/todo/deleteTodo/${id}`);
  ...
  const saveEdit = async () => {
    ...
    try {
      await axios.put(`https://to-do-app-backend-rho.vercel.app/api/todo/updateTodo/${editingTask._id}`, {
